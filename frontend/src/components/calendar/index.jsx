   ...
   render() {
    ...
    return (
         ...
         <div className="page-wrapper">
            ...
            <div className="content container-fluid">
              ...
              <div className="card ctm-border-radius shadow-sm grow">
									<div className="card-body">
										<a href="#0" className="btn btn-theme button-1 ctm-border-radius text-white btn-block"  onClick={()=>this.handleShow('createnew')}>
                                            <span><i className="fe fe-plus"></i></span> Create New</a>
									</div>
								</div>
							<div className="card">
								...
								<div className="card-body">
									<div id="calendar-events" className="mb-3">
										<div className="calendar-events"><i className="fa fa-star text-primary"></i> My Event One</div>
										<div className="calendar-events"><i className="fa fa-star text-success"></i> My Event Two</div>
										<div className="calendar-events"><i className="fa fa-star text-danger"></i> My Event Three</div>
										<div className="calendar-events"><i className="fa fa-star text-warning"></i> My Event Four</div>
									</div>
									...
									<a href="#0" className="btn btn-primary btn-block button-1" onClick={()=>this.handleShow('addcategory')}>
            ...
            {/* /Add Category Modal*/}
              {/*add category */}
              <Modal show={this.state.show === 'addcategory'} onHide={this.handleClose} centered>
			...
			<Modal show={this.state.show === 'createnew'} onHide={this.handleClose} centered>
                        <Modal.Header closeButton>
