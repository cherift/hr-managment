                    ...
                    <div className="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
										...
										<div className="row">
											<div className="col-md-12 mr-auto text-left">
												...
												<div className="custom-breadcrumb">
														...
														<h4 className="text-dark">Team Members</h4>
													</div>
												</div>
											</div>
										</div>
								...
								<div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div className="card-body">
										<div className="flex-column list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a className={`list-group-item ${this.state.tab === 'tab1' ? 'active' : ''}`} id="v-pills-home-tab"  href="#v-pills-home" onClick={()=>this.handleShow('tab1')}>View & Edit Details</a>
											<a className={`list-group-item ${this.state.tab === 'tab2' ? 'active' : ''}`} id="v-pills-profile-tab"  href="#v-pills-profile" onClick={()=>this.handleShow('tab2')}>Book Time Off</a>
											<a className={`list-group-item ${this.state.tab === 'tab3' ? 'active' : ''}`} id="v-pills-profile-tab"  href="#v-pills-profile" onClick={()=>this.handleShow('tab3')}>View Own Salaries</a>
										</div>
									</div>
								</div>
							</aside>
                        ...
                        <div className="col-xl-9 col-lg-8  col-md-12">
                           <div className="card ctm-border-radius shadow-sm">
								...
								<h4 className="card-title mb-0 d-inline-block">Your Team Members</h4>
								</div>
								<div className="card-body">
									...
									<span className="avatar" data-toggle="tooltip" data-placement="top" title="Richard Wilson">
										...
										<span className="ml-4">2 Team Members</span>
									</a>
								</div>
							</div>
                            {/*card*/}
                            <div className="card ctm-border-radius shadow-sm">
								<div className="card-body">
									<div className="tab-content" id="v-pills-tabContent">
											...
											<table className="table admin-table table-hover">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch3" disabled />
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch5" disabled />
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch11" disabled />
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch13" disabled />
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch15" disabled />
														...
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch17" disabled />
																	<label className="custom-control-label" for="switch3"></label>
																</div>
															</td>
															<td className="pb-0">
											...
											<table className="table admin-table table-hover">
													...
													<tbody>
														<tr>
															<td>
																<div>
																	<h6 className="mb-0">Work From Home</h6>
																	<p className="ctm-text-sm">Create, edit, or delete working from home days </p>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
														...
														<tr>
															<td className="pb-0">
																<div>
																	<h6 className="mb-0">Book Time Off</h6>
																	<p className="ctm-text-sm">Book, edit, or delete requests for time off and sickness </p>
																</div>
															</td>
															<td className="pb-0">
																<div className="custom-control custom-switch">
										...
										{/* <!-- /Tab2 --> */}
											{/* <!-- Tab3--> */}
											<div className={`tab-pane fade show ${this.state.tab === 'tab3' ? 'active' : ''} `} id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
											<div className="table-responsive">
											<table className="table admin-table table-hover">
													<thead>
														<tr>
