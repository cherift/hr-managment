...
class Securityreports extends Component {
	constructor(props){
		super(props);
		this.state = {
			showTable: null,
			data:[
         {id:1,image:IMG01,Name: 'Danny Ward', Email: 'danyward@example.com', Job: 'Design Team Lead', Team: 'Design', Office: 'Focus Technology'},
         {id:2,image:IMG02,Name: 'Linda Craver', Email: 'lindacraver@example.com', Job: 'IOS Team Lead', Team: 'IOS', Office: 'Focus Technology'},
         {id:3,image:IMG04,Name: 'Jenni Sims', Email: '	johndrysdale@example.com', Job: 'Android Team Lead', Team: 'PHP', Office: 'Focus Technology'},
        ],
