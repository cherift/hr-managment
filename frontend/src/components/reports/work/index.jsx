...
class Workhomereports extends Component {
	constructor(props){
		super(props);
		this.state = {
			showTable: null,
			data:[
            {id:1,image:IMG01,Name: 'Danny Ward', Email: 'danyward@example.com', wfh: '2'},
            {id:2,image:IMG02,Name: 'Linda Craver', Email: 'mariacotton@example.com', wfh: '6'},
            {id:3,image:IMG04,Name: 'Jenni Sims', Email: 'richardwilson@example.com', wfh: '5'},
        ],
  ...
  export default Workhomereports;