											...
											<div className="col-md-12 mr-auto text-left">
												<div className="custom-search input-group">
													<div className="custom-breadcrumb">
                                                        ...
                                                        <h4 className="text-dark">Team Leads</h4>
													</div>
												</div>
											</div>
										</div>
								...
								<div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div className="card-body">
										<div className="flex-column list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a className={`list-group-item ${this.state.tab === 'tab1' ? 'active' : ''}`} id="v-pills-home-tab"  href="#v-pills-home" onClick={()=>this.handleShow('tab1')}>Manage Details</a>
											<a className={`list-group-item ${this.state.tab === 'tab2' ? 'active' : ''}`} id="v-pills-profile-tab"  href="#v-pills-profile" onClick={()=>this.handleShow('tab2')}>Manage Time Off</a>
											<a className={`list-group-item ${this.state.tab === 'tab3' ? 'active' : ''}`} id="v-pills-messages-tab"  href="#v-pills-messages" onClick={()=>this.handleShow('tab3')}>Manage Team</a>
                            ...
                            <div className="card ctm-border-radius shadow-sm">
								<div className="card-body">
									<div className="tab-content" id="v-pills-tabContent">
										...
										{/* <!-- Tab1--> */}
										<div className={`tab-pane fade show ${this.state.tab === 'tab1' ? 'active' : 'hide'} `} id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
										...
										{/* <!-- Tab2--> */}
										<div className={`tab-pane fade show ${this.state.tab === 'tab2' ? 'active' : 'hide'} `} id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                        <div className="table-responsive">
												<table className="table admin-table table-hover">
													<thead>
														<tr>
										...
										{/* <!-- Tab3--> */}
										<div className={`tab-pane fade show ${this.state.tab === 'tab3' ? 'active' : 'hide'} `} id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                        <div className="table-responsive">
												<table className="table admin-table table-hover">
													<thead> 
														<tr>
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch25" disabled />
